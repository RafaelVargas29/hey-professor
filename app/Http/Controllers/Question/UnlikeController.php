...
class UnlikeController extends Controller
{
    ...
    {
        // Diz que o usuário não gostou da pergunta
        user()->unlike($question); // Para usar essa linha desse jeito precisa mexer o composer.json e criar um diretório Support com um arquivo Function.php com função global
